...
import agentEventsRouter from "./v1/agent-events.js";
import activityEventsRouter from "./v1/activity-events.js";
import casesRouter from "./v1/cases.js";
import approvalsRouter from "./v1/approvals.js";
import evidenceRouter from "./v1/evidence.js";
import evidenceImagesRouter from "./v1/evidence-images.js";
...
router.use(agentEventsRouter);
router.use(activityEventsRouter);
router.use(casesRouter);
router.use(approvalsRouter);
router.use(evidenceRouter);
router.use(evidenceImagesRouter);
